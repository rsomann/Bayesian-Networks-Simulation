## CS 3600 Assignment 3: Bayes Nets
...
1. Clone the project repository from Github
   ...
   ```
   git clone https://github.gatech.edu/AI-Spring23/assignment3_<gt_github_username>.git
   ```
...
**Important: You may only submit up to 3 times every 360 minutes.**
...
We are providing helper functions to calculate these posterior probabilities for you: `getA`, `getBvC`, `getB`, and `getC`.
...
We are providing helper functions to calculate these posterior probabilities for you: `getA`, `getBvC`, `getB`, `getC`, and `calculateMH`.
